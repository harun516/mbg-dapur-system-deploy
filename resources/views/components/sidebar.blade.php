    ...
    <div class="offcanvas-body p-0">
        ...
        <!====================================== ROLE ADMIN =====================================>
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark d-flex align-items-center py-2 px-3 rounded {{ request()->routeIs('admin.recipients.*') ? 'active bg-primary-subtle text-primary' : 'hover-bg-light' }}" href="{{ route('admin.recipient.index') }}">
                        <i class="fas fa-id-badge me-3 fs-5"></i> Penerima Manfaat
                    </a>
                </li>

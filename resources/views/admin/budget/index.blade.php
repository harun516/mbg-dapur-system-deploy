...
<style>
    ...
    * {
    ...
    .card.border-primary:hover {
        border-color: #4e73df !important;
        box-shadow: 0 0 20px rgba(78, 115, 223, 0.15) !important;
    }

    /* Modal Error Responsive */
    .modal-dialog {
        padding: 0.5rem;
    }
    ...
    /* Text Wrapping untuk Nominal Besar */
    #display-saldo-desktop,
    #display-nominal-desktop,
    #display-saldo-mobile,
